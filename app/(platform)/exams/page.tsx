...
import { mockStudents, mockTeachers, Student } from "@/lib/mockData";
...
export default function TeacherDashboard() {
  ...
  // Simulating a logged-in teacher (you would typically get this from an auth context)
  const loggedInTeacher = mockTeachers[3];
  ...
  const viewableStudents = useMemo(() => getViewableStudents(loggedInTeacher, mockStudents), [loggedInTeacher]);
    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage your subjects and student grades</CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="all" className="space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <TabsList className="grid grid-cols-2 sm:flex">
                ...
                {loggedInTeacher?.subjects.map((subject) => (
                      ...
                      <TableBody>
                        {students?.map((student) => (
                          <StudentRow
                            ...
                            viewableSubjects={getViewableSubjects(loggedInTeacher, student)}
                          />
                        ))}
                      </TableBody>
                    </Table>
